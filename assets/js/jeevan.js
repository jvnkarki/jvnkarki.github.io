/*-----------------------------------------------------------
* Template Name    : Portfolio | Responsive One Page HTML Template
...
// Add smooth scrolling to all links
     $("#menu .list-group-item a").on('click', function(event) {
...
$(window).scroll(function() {
       ...
       if (windscroll >= 100) {
           ...
           $('#main .section').each(function(i) {
            console.log('pt:'+$(this).position().top+'ws:'+windscroll);
               if ($(this).position().top <= windscroll + 50 ) {
                   $('#menu .list-group-item a').removeClass('active');
                   var ids = $(this).attr('id');
                   console.log(ids);
                   $('#menu .list-group-item a.' + ids).addClass('active');
               }
           });
           ...
           $('#menu .list-group-item a').removeClass('active');
           $('#menu .list-group-item:first a').addClass('active');
       }
   }).scroll();
